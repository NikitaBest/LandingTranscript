...
export default function Benefits() {
  const benefits = [
    ...
    },
    {
      ...
      description:
        "Сервис автоматически создаёт жалобы, объективный статус, план лечения, комментарий врача и итоговый раздел консультации.",
    },
    {
        ...
        <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          {benefits.map((benefit, index) => (
            <motion.div
              ...
              className="group p-6 md:p-8 rounded-3xl bg-secondary/20 hover:bg-secondary/40 transition-colors border border-transparent hover:border-primary/10"
            >
              <div className="w-12 h-12 md:w-16 md:h-16 rounded-2xl bg-white shadow-sm flex items-center justify-center text-primary mb-4 md:mb-6 group-hover:scale-110 transition-transform duration-300 shrink-0">
                {benefit.icon}
              </div>
